const $ = s => document.querySelector(s), $$ = s => document.querySelectorAll(s);
        ...
        // ========================================================
        // INJEÇÃO AUTOMÁTICA DE DADOS DO BANCO DO EA FC (UEADBM)
        // ========================================================
        fetch('/data/database.json')
            .then(res => res.json())
            .then(db => {
                if (db && db.roster) {
                    const season = appData.elencos[appData.indiceAtivo].temporadas[appData.elencos[appData.indiceAtivo].temporadaAtiva];
                    // Mapeia o Roster do EA FC para o formato que o Dashboard original entende
                    season.jogadores = db.roster.map(p => ({
                        primeiroNome: p.firstName || p.name,
                        sobrenome: p.lastName || "",
                        num: p.jerseyNumber,
                        pos: p.position || "RES",
                        status: p.contract.role === "1" ? "Crucial" : (p.contract.role === "2" ? "Importante" : "Rotação"), // Mapeamento básico
                        situacao: p.statusElenco, // Titular, Reserva, Não Relacionado
                        idade: Math.floor((150000 - parseInt(p.age)) / 365) || 20, // Aproximação temporária da idade do EA DB
                        alt: p.height || 180,
                        pe: "Dir.", // A extrair do weak foot depois
                        contAnos: Math.floor(p.contract.monthsLeft / 12) || 0,
                        contMeses: (p.contract.monthsLeft % 12) || 0,
                        multa: 0,
                        valor: 0, // Pode cruzar com career_finance depois
                        salario: p.contract.wage,
                        ovr: p.overall,
                        pot: p.potential,
                        dr: p.attributes.skillmoves || 3,
                        pr: p.attributes.weakfoot || 3,
                        s: [
                            parseInt(p.attributes.sprintspeed) || 0,
                            parseInt(p.attributes.finishing) || 0,
                            parseInt(p.attributes.shortpassing) || 0,
                            parseInt(p.attributes.dribbling) || 0,
                            parseInt(p.attributes.strength) || 0,
                            parseInt(p.attributes.stamina) || 0
                        ],
                        est: {}
                    }));
                    renderizar();
            ...
            .catch(e => console.warn('Não foi possível carregar database.json local', e));
        ...
        const formacoesTaticas = {
            "4-3-3": {slots:{"GOL":"bottom:10%;left:50%","LE":"bottom:30%;left:15%","ZAG1":"bottom:25%;left:35%","ZAG2":"bottom:25%;left:65%","LD":"bottom:30%;left:85%","MC1":"bottom:50%;left:30%","MEI":"bottom:60%;left:50%","MC2":"bottom:50%;left:70%","PE":"bottom:80%;left:20%","ATA":"bottom:90%;left:50%","PD":"bottom:80%;left:80%"}},
            "4-4-2": {slots:{"GOL":"bottom:10%;left:50%","LE":"bottom:30%;left:15%","ZAG1":"bottom:25%;left:35%","ZAG2":"bottom:25%;left:65%","LD":"bottom:30%;left:85%","ME":"bottom:55%;left:15%","MC1":"bottom:55%;left:38%","MC2":"bottom:55%;left:62%","MD":"bottom:55%;left:85%","ATA1":"bottom:88%;left:38%","ATA2":"bottom:88%;left:62%"}},
            "4-2-3-1": {slots:{"GOL":"bottom:10%;left:50%","LE":"bottom:30%;left:15%","ZAG1":"bottom:25%;left:35%","ZAG2":"bottom:25%;left:65%","LD":"bottom:30%;left:85%","VOL1":"bottom:45%;left:35%","VOL2":"bottom:45%;left:65%","MEI":"bottom:60%;left:50%","PE":"bottom:75%;left:20%","PD":"bottom:75%;left:80%","ATA":"bottom:90%;left:50%"}},
            "4-1-4-1": {slots:{"GOL":"bottom:10%;left:50%","LE":"bottom:30%;left:15%","ZAG1":"bottom:25%;left:35%","ZAG2":"bottom:25%;left:65%","LD":"bottom:30%;left:85%","VOL":"bottom:42%;left:50%","ME":"bottom:60%;left:15%","MC1":"bottom:55%;left:35%","MC2":"bottom:55%;left:65%","MD":"bottom:60%;left:85%","ATA":"bottom:90%;left:50%"}},
            "3-5-2": {slots:{"GOL":"bottom:10%;left:50%","ZAG1":"bottom:25%;left:25%","ZAG2":"bottom:22%;left:50%","ZAG3":"bottom:25%;left:75%","VOL1":"bottom:45%;left:35%","VOL2":"bottom:45%;left:65%","ME":"bottom:65%;left:15%","MEI":"bottom:60%;left:50%","MD":"bottom:65%;left:85%","ATA1":"bottom:90%;left:35%","ATA2":"bottom:90%;left:65%"}},
            "5-3-2": {slots:{"GOL":"bottom:10%;left:50%","ADE":"bottom:30%;left:12%","ZAG1":"bottom:23%;left:30%","ZAG2":"bottom:21%;left:50%","ZAG3":"bottom:23%;left:70%","ADD":"bottom:30%;left:88%","MC1":"bottom:55%;left:30%","VOL":"bottom:45%;left:50%","MC2":"bottom:55%;left:70%","ATA1":"bottom:90%;left:35%","ATA2":"bottom:90%;left:65%"}},
            "4-3-3 (Contenção)": {slots:{"GOL":"bottom:10%;left:50%","LE":"bottom:30%;left:15%","ZAG1":"bottom:25%;left:35%","ZAG2":"bottom:25%;left:65%","LD":"bottom:30%;left:85%","VOL":"bottom:45%;left:50%","MC1":"bottom:60%;left:30%","MC2":"bottom:60%;left:70%","PE":"bottom:80%;left:20%","ATA":"bottom:90%;left:50%","PD":"bottom:80%;left:80%"}},
            "4-3-3 (Ofensivo)": {slots:{"GOL":"bottom:10%;left:50%","LE":"bottom:30%;left:15%","ZAG1":"bottom:25%;left:35%","ZAG2":"bottom:25%;left:65%","LD":"bottom:30%;left:85%","MC1":"bottom:50%;left:35%","MC2":"bottom:50%;left:65%","MEI":"bottom:65%;left:50%","PE":"bottom:80%;left:20%","ATA":"bottom:90%;left:50%","PD":"bottom:80%;left:80%"}},
            "4-3-3 (Falso 9)": {slots:{"GOL":"bottom:10%;left:50%","LE":"bottom:30%;left:15%","ZAG1":"bottom:25%;left:35%","ZAG2":"bottom:25%;left:65%","LD":"bottom:30%;left:85%","MC1":"bottom:50%;left:30%","MC2":"bottom:50%;left:70%","MEI":"bottom:65%;left:50%","PE":"bottom:80%;left:20%","SA":"bottom:78%;left:50%","PD":"bottom:80%;left:80%"}}
        };
