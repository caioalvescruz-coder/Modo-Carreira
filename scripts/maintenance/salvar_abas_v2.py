...
def main():
    print("========================================")
    print("🤖 ROBÔ DE SALVAR ABAS DO SOFIFA v2 🤖")
    print("========================================")
    print("O robô vai salvar da página '2.2' até a '2.30' (29 páginas no total).")
    print("\nINSTRUÇÕES FINAIS:")
    print("1. Salve a primeira aba manualmente como '2.1' na pasta desejada (para o Chrome lembrar a pasta).")
    print("2. Deixe o Google Chrome aberto NA PRIMEIRA ABA (a que você acabou de salvar como 2.1).")
    ...
    # Vamos do 2 ao 30
    for i in range(2, 31):
        print(f"[{i-1}/29] Trocando de aba e salvando como 2.{i}...")
    ...
    print("\n✅ Finalizado! Todas as 29 abas extras foram salvas (2.2 até 2.30).")
